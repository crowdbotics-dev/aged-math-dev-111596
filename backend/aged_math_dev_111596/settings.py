"""
Django settings for aged_math_dev_111596 project.
...
ROOT_URLCONF = 'aged_math_dev_111596.urls'
...
WSGI_APPLICATION = 'aged_math_dev_111596.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_math_dev_111596 API",
    "DESCRIPTION": "API documentation for aged_math_dev_111596 App",
    "VERSION": "v1",
}
